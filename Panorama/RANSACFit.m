...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    edit_pt1=pt1(match(:, 1),:);
    edit_pt2=pt2(match(:, 2),:);
    vec_pt1 = [edit_pt1';ones(1,size(edit_pt1,1))];
    vec_pt2 = [edit_pt2';ones(1,size(edit_pt2,1))];
    res_pt1 = H*vec_pt1;
    euclidean = sqrt(sum((res_pt1-vec_pt2).^2));
    dists = euclidean';
