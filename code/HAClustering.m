...
%                                                                     %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
centroids(i,:) = (centroids(i,:)*cluster_sizes(i) + centroids(j,:))/(cluster_sizes(i)+1);
centroids(j,:) = Inf;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                     %
%                            END YOUR CODE                            %
...
%                                                                     %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cluster_sizes(i) = cluster_sizes(j) + cluster_sizes(i);
cluster_sizes(j) = 0;
...
%                                                                     %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%finishing j means j no longer needs more change of cluster
dists(:,j) = Inf;
dists(j,:) = Inf;
newlinei = pdist2(centroids(i,:),centroids,'euclidean');
newrowi = newlinei';
dists(i,:) = newlinei;
dists(:,i) = newrowi;
%special points set to infinity
dists(i,i) = Inf;
dists(i,j) = Inf;
dists(j,i) = Inf;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
